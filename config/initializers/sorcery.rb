...
# Available submodules are: :http_basic_auth, :external, :remember_me, :activity_logging
# , :reset_password
Rails.application.config.sorcery.submodules = [:user_activation, :reset_password, :session_timeout, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    # user.activation_token_expiration_period = 600


    # your mailer class. Required.
    # Default: `nil`
    #
    user.user_activation_mailer = VendorMailer
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = VendorMailer
    ...
    # Default: `60 * 60`
    #
    user.login_lock_time_period = 300
    ...
    # Default: `nil`
    #
    user.unlock_token_mailer = VendorMailer
